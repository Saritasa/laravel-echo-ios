...
class SocketIOPresenceChannel: SocketIoChannel, IPresenceChannel {
    ...
    func here(callback _: NormalCallback) -> IPresenceChannel {
        return self
    }
    ...
    /// - Parameter callback: callback
    /// - Returns: the presence channel itself
    func joining(callback _: NormalCallback) -> IPresenceChannel {
        return self
    }
    ...
    /// - Parameter callback: callback
    /// - Returns: the presence channel itself
    func leaving(callback _: NormalCallback) -> IPresenceChannel {
        return self
    }
}
